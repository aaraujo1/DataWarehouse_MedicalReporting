...
create schema FacilityMeasures_US
go;
...
create table FacilityMeasures_US.[Facilities]
(
...
create table FacilityMeasures_US.[MeasureTypes]
(
...
-- table for measures
create table FacilityMeasures_US.[Measures]
(
    ...
    constraint fk_Measures_MeasureTypeID foreign key (MeasureTypeID)
        references FacilityMeasures_US.[MeasureTypes] (MeasureTypeID)
)
go;

-- table for facility measures
create table FacilityMeasures_US.[FacilityMeasures]
(
    ...
    constraint fk_FacilityMeasures_FacilityID foreign key (FacilityID)
        references FacilityMeasures_US.[Facilities] (FacilityID),
    constraint fk_FacilityMeasures_MeasureID foreign key (MeasureID)
        references FacilityMeasures_US.[Measures] (MeasureID),
)
go;